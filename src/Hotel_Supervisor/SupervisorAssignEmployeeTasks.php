	...
	<div class="staytablesupervisor">
		<table border="1px solid white" style="color:white; width:100%">
			<tr>
				...
				<th colspan="4">
					<h2>View Staying Booking Details</h2>
				</th>
			</tr>
			<tr>
				<th>CheckIn Date:</th>
	...
	<div class="dinetablesupervisor">
		<table border="1px solid white" style="color:white; width:100%">
			<tr>
				<th><img src="../../public/images/BigCal.png" height="70px"></th>
				<th colspan="3">
					<h2>View Dine-in Booking Details</h2>
				</th>
			</tr>
			<tr>
				<th>Date:</th>
		...
		<div class="eventtable">
			<table border="1px solid white" style="color:white; width:100%">
				<tr>
					<th><img src="../../public/images/BigCal.png" height="70px"></th>
					<th colspan="4">
						<h2>View Events Booking Details</h2>
					</th>
				</tr>
				<tr>
		...
		<script>
			...
			style = "color:white; width:100%" >
				...
				tr >
				<
				th > < img src = "../../public/images/BigCal.png"
			height = "70px" > < /th> <
				th colspan = "4" >
				<
				h2 > View Events Booking Details < /h2> <
