...
if (isset($_POST['ADD'])) {
    ...
    $sqlemployee = "INSERT into employee(Employee_ID,First_Name,Last_Name,Email,Password,Contact_No,User_Role) VALUES ('" . $empID . "','" . $empFname . "','" . $empSname . "','" . $empEmail . "','" . $empPass . "','" . $empContact . "','" . $empType . "')";
    $sqllogin = "INSERT into login_table(Email,Password,User_Type) VALUES ('" . $empEmail . "','" . $empPass . "','" . $userType . "')";
    $query_run = mysqli_query($con, $sqlemployee);
    $query_run1 = mysqli_query($con, $sqllogin);
