...
<body bgcolor="black">
  ...
  <div class="sidenav">
		<button class="dropdown-btn">
			<i class="fa fa-caret-down">View Stats</i>
		</button>
  ...
  <button style="position:absolute;top:37%;right:20%;color:white;background-color:purple;border:none;padding:5px 15px;border-radius:10px;width:15%;cursor:pointer" onclick="window.location.href='mealprice.php'">
