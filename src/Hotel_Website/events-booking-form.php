    ...
    <form action="events-booking.php" method="post" id="event-booking">
        <div class="events-booking-form" id="events-booking-form">
            ...
            <div class="payment-cancel-btns">
                ...
                <div class="check-availability-shower" id="check-availability-shower" style="display:none;background-color:white;left:8%;top:54%;position:absolute;height:290px;width:25%;padding:14px 5px;border-radius:5px;" id="check-availability-shower">
                </div>
            </div>
        </div>
    </form>
