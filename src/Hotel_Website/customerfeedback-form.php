    ...
    <div class="bg-modal-customer-feedback" id="bg-modal-early-request">
        <div class="modal-content early-request">
            ...
            <form action="" method="post">
                ...
                <input type="text" name="customer-name" id="" style="margin-top:10px;height:100px">
                ...
                <label for="">Give a Feedback about the service of our staff</label>
                <div style="display: inline-block;">
                    ...
                    <input type="submit" value="Provide Feedback" style="margin: 5px;padding: 7px;border-radius: 4px;border: none;background-color: #3498db;color: #fff;font-size: 15px;  cursor: pointer;">
                </div>
            </form>
        </div>
    </div>
