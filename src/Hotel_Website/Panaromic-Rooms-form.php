            ...
            <div class="suite-form-details">
                <form action="suite-insert.php" method="post">
                    ...
                    <div class="form-page">
                        ...
                        <div class="button-container-suite-form" style="margin-top:50px;">
