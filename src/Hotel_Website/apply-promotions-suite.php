    ...
    <div class="suite-rooms-form-container room-detail paymentuser" style="height:105vh;display:none;" id="form-page-paymentuser-setmenu">
        ...
        <div class="form-page-fields-user">
            ...
            <div class="payment-details">
                <div style="margin-top:8px;font-weight:bolder"><label for="Payment-Deatils" style="font-size:45px;color:white;" ;>Payment Details</label></div>
                <fieldset style="width: 480px;height:450px;margin-top:70px;background-color:white;border-radius:10px;border:none;padding:10px;">
                    ...
                    <div class="total-amount" style="font-weight: bolder;font-size:30px;margin-bottom:10px;margin-top:20px;"><u>Promotion Details</u></div>
                    <label for="">Seasonal Offer <br><br></label><span style="font-weight: bolder;text-align:center;position:absolute;top:52%;right:17%"> 20%</span>
                    <label for="">Amount Reduced <br><br></label><span style="font-weight: bolder;text-align:center;position:absolute;top:58%;right:17%">Rs.11240.00/=</span>
                    <label for="">Total Amount after Promotion <br><br></label><span style="font-weight: bolder;text-align:center;position:absolute;top:63%;right:17%">Rs.44960.00/=</span>
                    <div class="total-amount" style="font-weight: bolder;font-size:30px;margin-bottom:10px;margin-top:-10px;"><u>Advance Amount</u></div>
                    <label for="">Advance Amount <br>(after Promotion)<br><br></label><span style="font-weight: bolder;text-align:center;position:absolute;top:73%;right:14%">Rs.44960.00 <b>*</b> 20%</span>
                    <span style="font-weight: bolder;text-align:center;position:absolute;top:77%;right:18%;font-size:20px">= Rs.8992.00/= </span>
