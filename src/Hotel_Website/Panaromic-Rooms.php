    ...
    <div class="page-wrapper">
        ...
        <div class="body-container Panaromic-Rooms">
            <div class="panaromic-rooms-wrapper">
                ...
                <button class="book" style="color:black;background-color:goldenrod"><a href="Panaromic-Romms-form.php" target="_blank">Book Now</a></button>
            </div>
            ...
            <div class="room-container">
                ...
                <div class="room-details">
                    ...
                    <div class="room-details-wrapper">
                        <div class="grid-room-container"><i class="fa fa-list-ol" aria-hidden="true"><span class="room-detail">Number of Rooms</span><br><span class="Superior-values">18</span></i></div>
